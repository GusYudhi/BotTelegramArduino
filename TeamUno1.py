...
def handle_button_click(callback_query):
    ...
    if button_data == "relay1":
        keyboard = {
            "inline_keyboard": [
                [{"text": "Hidup", "callback_data": "relay1_hidup"}],
                [{"text": "Mati", "callback_data": "relay1_mati"}]
            ]
        }
        send_telegram_request("sendMessage", {"chat_id": user_id, "text": "Pilih status untuk Relay 1:", "reply_markup": keyboard})

    elif button_data == "relay2":
        keyboard = {
            "inline_keyboard": [
                [{"text": "Hidup", "callback_data": "relay2_hidup"}],
                [{"text": "Mati", "callback_data": "relay2_mati"}]
            ]
        }
        send_telegram_request("sendMessage", {"chat_id": user_id, "text": "Pilih status untuk Relay 2:", "reply_markup": keyboard})

    elif button_data == "red_censor":
        keyboard = {
            "inline_keyboard": [
                [{"text": "Hidup", "callback_data": "red_censor_hidup"}],
                [{"text": "Mati", "callback_data": "red_censor_mati"}]
            ]
        }
        send_telegram_request("sendMessage", {"chat_id": user_id, "text": "Pilih status untuk Red Censor:", "reply_markup": keyboard})
